...
ast::AstNode* TOK_DECLARATIONLIST() {
    ...
    if (current == TokenType::IDENTIFIER || current == TokenType::TOK_CLASS || current == TokenType::TOK_DOUBLE || current == TokenType::TOK_FLOAT || current == TokenType::TOK_INT || current == TokenType::TOK_STRING || current == TokenType::TOK_VECTOR) {
...
ast::AstNode* TOK_DECLARATION() {
    ...
    if (current == TokenType::IDENTIFIER || current == TokenType::TOK_DOUBLE || current == TokenType::TOK_FLOAT || current == TokenType::TOK_INT || current == TokenType::TOK_STRING || current == TokenType::TOK_VECTOR) {
...
ast::AstNode* TOK_STATEMENT() {
    ...
    if (current == TokenType::NUMBER || current == TokenType::STRING || current == TokenType::TOK_EXCL || current == TokenType::TOK_INPUT || current == TokenType::TOK_LPAREN || current == TokenType::TOK_MINUS || current == TokenType::TOK_MINUSMINUS || current == TokenType::TOK_PLUSPLUS || current == TokenType::TOK_PRINT) {
...
ast::AstNode* TOK_EXPR02REST() {
    ...
    if (current == TokenType::None || current == TokenType::TOK_AMPEQUAL || current == TokenType::TOK_CARETEQUAL || current == TokenType::TOK_EQUAL || current == TokenType::TOK_LSHIFTEQUAL || current == TokenType::TOK_MINUSEQUAL || current == TokenType::TOK_PERCENTEQUAL || current == TokenType::TOK_PLUSEQUAL || current == TokenType::TOK_RSHIFTEQUAL || current == TokenType::TOK_SLASHEQUAL || current == TokenType::TOK_STAREQUAL) {
...
ast::AstNode* TOK_EXPR14() {
    ...
    if (current == TokenType::TOK_EXCL || current == TokenType::TOK_MINUS || current == TokenType::TOK_MINUSMINUS || current == TokenType::TOK_PLUSPLUS) {
    ...
    else if (current == TokenType::IDENTIFIER || current == TokenType::NUMBER || current == TokenType::STRING || current == TokenType::TOK_INPUT || current == TokenType::TOK_LPAREN || current == TokenType::TOK_PRINT) {
...
ast::AstNode* TOK_EXPR15() {
    ...
    if (current == TokenType::IDENTIFIER || current == TokenType::NUMBER || current == TokenType::STRING || current == TokenType::TOK_INPUT || current == TokenType::TOK_LPAREN || current == TokenType::TOK_PRINT) {

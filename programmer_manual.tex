...
Лексер использует алгоритм Ахо-Корасика для эффективного распознавания ключевых слов. Алгоритм строит конечный автомат, который позволяет находить все вхождения ключевых слов за один проход по тексту.
